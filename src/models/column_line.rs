//! ColumnLine model for Appwrite SDK
...
pub struct ColumnLine {
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub default: Option<Vec<Vec<f64>>>,
}
...
impl ColumnLine {
    ...
    /// Set default
    pub fn set_default(mut self, default: Vec<Vec<f64>>) -> Self {
...
mod tests {
    ...
    #[test]
    fn test_column_line_creation() {
        let _model = <ColumnLine as Default>::default();
        let _ = _model.key();
        let _ = _model.r#type();
        let _ = _model.status();
        let _ = _model.error();
    ...
    #[test]
    fn test_column_line_serialization() {
        let model = <ColumnLine as Default>::default();
        let json = serde_json::to_string(&model);
        assert!(json.is_ok());

        let deserialized: Result<ColumnLine, _> = serde_json::from_str(&json.unwrap());

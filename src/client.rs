...
impl Client {
    ...
    pub fn new() -> Self {
        ...
        headers.insert("user-agent", format!("AppwriteRustSDK/0.1.1 ({}; {})", std::env::consts::OS, std::env::consts::ARCH).parse().unwrap());
        ...
        headers.insert("x-sdk-version", "0.1.1".parse().unwrap());
